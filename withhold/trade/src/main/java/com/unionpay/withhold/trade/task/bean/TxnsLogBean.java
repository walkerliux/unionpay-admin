...
public class TxnsLogBean implements Serializable{
	...
	public boolean equals(Object o) {
		if (!(o instanceof TxnsLogBean)) {
			return false;
		}
		TxnsLogBean txnLogPay = (TxnsLogBean) o;
		return this.txnseqno.equals(txnLogPay.getTxnseqno());
	}
