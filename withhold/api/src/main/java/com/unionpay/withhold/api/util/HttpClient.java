...
/*import com.unionpay.dk.common.util.acp.BaseHttpSSLSocketFactory;
import com.unionpay.dk.common.util.acp.BaseHttpSSLSocketFactory.TrustAnyHostnameVerifier;*/
...
public class HttpClient {
	 ...
	 * @throws Exception
	 */
	public int send(String sendData, String encoding) throws Exception {
		try {
	...
	private HttpURLConnection createConnection(String encoding) throws ProtocolException {
		...
		httpURLConnection.setRequestProperty("Content-type", "text/xml;charset=" + encoding);
