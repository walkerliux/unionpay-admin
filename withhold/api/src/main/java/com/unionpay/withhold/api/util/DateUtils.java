...
public class DateUtils extends org.apache.commons.lang.time.DateUtils {
	...
	public static final SimpleDateFormat formatTimesString = new SimpleDateFormat("yyyyMMddHHmmss");
	...
	public static String geCurrentDateTimeStr() {
		return formatTimesString.format(new Date());
	}
