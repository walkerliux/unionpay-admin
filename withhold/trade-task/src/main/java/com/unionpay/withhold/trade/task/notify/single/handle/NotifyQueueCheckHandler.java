...
@Component("notifyQueueCheckHandler")
public class NotifyQueueCheckHandler implements EventHandler<TradeNotifyBean>{
	private final static Logger log = LoggerFactory.getLogger(NotifyQueueCheckHandler.class);
	@Autowired
