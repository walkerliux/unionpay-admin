...
if (typeof(rows) == "undefined") {
    ...
    p.location.href='/admin/login/logout';
}
/** end   张连海变更 **/
...
//----------------------以下是增加的内容---------------------   
var cell_width = 25;  
if((_5b1+"").length >= 4 && (_5b1+"").length < 6){  
cell_width = 35;  
}else if((_5b1+"").length >= 6 && (_5b1+"").length < 8){  
cell_width = 40;  
}else if((_5b1+"").length >= 8 && (_5b1+"").length < 11){  
cell_width = 55;  
}  
cc.push("<td class=\"datagrid-td-rownumber\"><div style='width:"+cell_width+"px' class=\"datagrid-cell-rownumber\">"+_5b1+"</div></td>");  
