			...
			<form id="theForm" method="post">
				<table width="100%">
					<tr>
						...
						<!-- <td align="right" width="8%">退款类型:</td>
						...
						<td align="right" width="8%">退款状态:</td>
	...
	<div id="w" class="easyui-window" closed="true" title="My Window" iconCls="icon-save" style="width: 800px; height: 200px; padding: 5px;">
		<div class="easyui-layout" fit="true">
			<div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc; text-align: center">
				<form id="firstTrial" method="post">
					<table width="100%" cellpadding="2" cellspacing="2" style="text-align: left" id="inputForm">
						...
						<tr align="center" style="height:40px;">
							<td align="right" width="50%">退款码:</td>
							<td align="left"><input placeholder="请输入退款码" name="chargeCode" required="true" type="text" class="easyui-textbox easyui-validatebox" maxlength="20" required="true" /></td>
						</tr>

						<tr align="center" style="height:40px;">
							<td align="right" width="50%">退款金额:</td>
							<td align="left"><input id="amount" placeholder="请输入退款金额" name="amount" required="true" type="text" class="easyui-textbox easyui-validatebox" maxlength="20" onkeyup="money()" required="true" />元 <span id="moneys"></span></td>
						</tr>
						<!-- <tr align="center">
							<td align="right" width="45%">退款渠道:</td>
			...
			<div region="south" border="false" style="text-align: center; padding: 5px 0;">
				<a class="easyui-linkbutton" iconCls="icon-ok" href="javascript:firstTrial()" id="btn_submit" onclick="">提交</a> <a class="easyui-linkbutton" iconCls="icon-cancel" href="javascript:void(0)" id="btn_submit" onclick="closeAdd()">取消</a>
			</div>
		</div>
	</div>
...
<script>
	...
	/* $(function() {
		$.ajax({
			...
			success : function(json) {
				var html = '<option value="">--请选择退款渠道--</option>';
	...
	// 提交退款信息
	function firstTrial() {
		$("#firstTrial").attr("action", "offline/refund");
