	...
	<div id="wadd" class="easyui-window" closed="true" title="My Window" iconCls="icon-save" style="width: 500px; height: 500px; padding: 5px;">
		<div class="easyui-layout" fit="true">
			...
			<div region="south" border="false" style="text-align: center; padding: 5px 0;">
				<a class="easyui-linkbutton" id="save_button_a" iconCls="icon-ok" href="javascript:addAmtAccumRate()" onclick="">保存</a> <a class="easyui-linkbutton" id="cancel_button_a" iconCls="icon-cancel" href="javascript:void(0)" onclick="closeAdd()">取消</a>
			</div>
		</div>
	</div>
			...
			<div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc; text-align: center">
				<form id="detailForm" action="" method="post">
					<table width="100%" cellpadding="2" cellspacing="2" style="text-align: left">
						...
						<tr height="50px">
							<td class="update">备注</td>
							<td class="update" colspan="3" id="notes_d"></td>
						</tr>
					</table>
				</form>
			</div>
		...
		$.ajax({
			...
			success : function(json) {
				...
				for (var i = 1; i <= rows.length; i++) {
					...
					$("#startRange_a" + i).val(row.STARTRANGE/100);
					$("#endRange_a" + i).val(row.ENDRANGE/100);
