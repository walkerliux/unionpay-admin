			...
			<form id="theForm" method="post">
				<table width="100%">
					<tr>
						...
						<td align="left" style="padding-left: 5px" width="25%"><input name="accfirmerno" id="accfirmerno" /></td>
				...
				.datagrid(
						{
							...
							onClickRow: function (index, row) { 
								...
								$('#detailInfo').datagrid({
									...
									nowrap: false,
									striped: true,
									url:"statistic/getTnxLogInfoByCoopno?accfirmerno="
										+ accfirmerno + "&retcode=" + retcode + "&stime="
										+ stime + "&etime=" + etime,
									remoteSort: false,
									idField:'TID',
									columns:[
