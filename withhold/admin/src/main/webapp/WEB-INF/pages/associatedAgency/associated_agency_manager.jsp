			...
			<form id="theForm" method="post">
				...
				<table width="100%" border="0">
					<tr>
						...
						<input id="merchId_ins" maxlength="15" /></td>
						<td align="right" width="10%">委托机构名称</td>
						<td align="left" style="padding-left: 5px" width="15%">
						<input id="memberName_ins" maxlength="50" /></td>
					</tr>
					<tr>
...
<script>
  	var width = $("#continer").width();
		$(function(){
			...
			if(flag=='1'){
				$('#test').datagrid({
					...
					nowrap: false,
					striped: true,
					url:'associatedagency/queryAgency?flag='+flag,
					remoteSort: false,
					columns:[
					[
						...
						toolbar:[{
							...
							iconCls:'icon-add',
							handler:function(){
								window.location.href= "<%=basePath%>" +'associatedagency/showAgencyAdd';
				...
				$('#test').datagrid({
					...
					[
						...
						{field:'LICENCE_NO',title:'营业执照号',width:130,align:'center'},
						{field:'CORPORATION',title:'法人名称',width:100,align:'center'}, 
						{field:'CONTACT',title:'联系人',width:100,align:'center'},
						{field:'STATUS',title:'状态',width:100,align:'center',
							formatter:function(value,rec){
		...
		function toMerchChange(merchApplyId){
			window.location.href= "<%=basePath%>" +'associatedagency/toMerchChange?merchApplyId='+merchApplyId;
		}

		function toMerchDetail(merchApplyId){
			flag=10;
			window.location.href= "<%=basePath%>" +'associatedagency/toMerchDetail?merchApplyId='+merchApplyId+'&flag='+flag;
		}
