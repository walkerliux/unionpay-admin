	...
	<div style="margin: 5px;" id="continer">
		<div id="title" name="title" class="easyui-panel" title="委托机构修改 "
			...
			<div style="padding-left: 5px; padding-right: 5px">
				<form id="merchDetaForm" action="associatedagency/saveMerchModifyDeta" method="post">
					...
					<table width="100%">
						<tr>
							<td colspan="4"><font
								class="current-step">第一步:委托机构信息变更</font><img src="<%=basePath%>pictuer/tag.jpg" style="height: 10px"/>第二步:配置计费方式<img src="<%=basePath%>pictuer/tag.jpg" style="height: 10px"/>第三步:上传证件照片</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td width="35%">
								...
								missingMessage="请输入委托机构名称" class="easyui-validatebox" validType="MerchLength[60]" />
							</td>
						...
						<tr>
							...
							<td>
								<input name="agencyType" value="${merchDeta.agencyType}" maxlength="32" type="text" style="width: 250px"
								 class="easyui-validatebox" missingMessage="请输入委托机构类型"/>
							</td>
							<td align="center">
						...
						<tr>
							...
							<td>
								...
								value="${deposit}" name="deposit" value="0"/>
							</td>
							<td align="center">服务费（元）</td>
							<td>
								<input name="charge" maxlength="8" validType="amount" value="${charge}" style="width: 250px" 
								class="easyui-validatebox" type="text" value="0"/>
							</td>
						</tr>
						<tr>
							<td align="center">
						...
						<tr>
							...
							<td>
								...
								missingMessage="请输入税务登记号" validType="merLength[15]" id="add_taxno"
						...
						<tr>
							...
							<td>
								...
								missingMessage="请输入委托机构网站地址" validType="url" class="easyui-validatebox" />
							</td>
							<td></td>
							<td></td>
						</tr>
...
// 				}
	...
	function backToAgencyIndex(){
		var flag = 4;
		window.location.href= "<%=basePath%>" +'associatedagency/showMerchModify?flag=' + flag;
	}
