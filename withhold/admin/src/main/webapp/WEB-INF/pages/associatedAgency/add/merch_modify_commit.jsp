...
<body>
	<div style="margin: 5px;" id="continer">
		<div id="title" name="title" class="easyui-panel" title="委托机构变更"
			style="background: #fafafa;" iconCls="icon-save" collapsible="false">
			<div style="padding-left: 5px; padding-right: 5px">
				<form id="merchDateForm" action="associatedagency/commitMerch" method="post">
...
<script>
  $(function(){
	...
	function commitMerch(){
		$.ajax({
			type: "POST",
			url: "associatedagency/commitMerchModify",
