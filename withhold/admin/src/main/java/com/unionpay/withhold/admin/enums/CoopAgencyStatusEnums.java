...
public enum CoopAgencyStatusEnums {
	...
	private CoopAgencyStatusEnums(String code) {
		this.code = code;
	}

	public static CoopAgencyStatusEnums fromValue(String value) {
		for (CoopAgencyStatusEnums status : values()) {
